	...
	<div class="main-container d-flex">
		<div class="sidebar p-3 text-black bg-light" style="width: 250px; height: 100vh ; position: fixed; bottom:0">
			...
			<ul class="nav flex-column mt-4 d">
				...
				<li>
					<a href="<?= base_url('home/profil/' . user_id()) ?>" class="btn btn-light nav-link text-black mb-2 p-2" style="text-align: left; font-size: 12pt;">
				...
				<hr>
				<li>
					<a href="<?= base_url('logout') ?>" class="btn btn-light nav-link text-black mb-2 p-2" style="text-align: left; font-size: 12pt;">
